...
One can look at the global datasets and see that the data is imbalanced, the reason is that the majority of the countries in these datasets do not have a province/state, and that could cause a bias, in which I decided to remove this column and did not consider it in my analysis when it came to looking into the global data.   
